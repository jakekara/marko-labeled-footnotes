"""
Labeled footnotes extension
~~~~~~~~~~~~~~~~~~~

Enable labeled footnotes parsing and renderering in Marko. This code is forked 
from Marko's built-in footnotes util, but it allows for arbitrary string labels
of footnotes, rather than just numeric footnotes, and it allows labels to be 
non-unique if you specify a unique id.
